...
<head>
    ...
    <style>
        :root {
            ...
            --success-bg: #e6ffee;
            /* Light green for success box background */
            --success-border: #82e0aa;
            /* Slightly darker green for success box border */
        }
        ...
        .success-box {
            ...
            font-size: 14px;
            color: #21613d;
            /* Darker green text for success details */
        ...
        @media only screen and (max-width: 600px) {
            ...
            .success-box {
                /* Apply responsive styles to success-box */
                padding: 15px;
                font-size: 13px;
            }
...
<body>
    <div class="email-wrapper">
        ...
        <div class="email-header" style="background-color: #4427ae; color: white;">
            <h2><span>&#x1F4C6;</span> Monthly Attendance Report</h2>
        </div>

        <div class="email-body">
            <p>Dear Team,</p>

            <p>Please find attached the monthly attendance report for <span class="highlight">{{ $month }}
                    {{ $year }}</span>.</p>
            ...
            @if ($isCurrentMonth)
                <p class="warning">Note: This report covers attendance up to the previous day ({{ $reportEndDate }}), as
                    it was generated on {{ \Carbon\Carbon::now()->format('F j, Y') }}.</p>
            @else
