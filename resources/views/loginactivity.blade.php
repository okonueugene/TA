                    ...
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            ...
                            <div class="nk-block-des">
                                <p>Here is your last {{count($activities)}} login activities log. <span class="text-soft"><em
                    ...
                    <table class="table table-ulogs">
                        ...
                        <tbody>
                            @foreach ($activities as $activity)
                                <tr>
                                    <td class="tb-col-os">{{ $activity->description }}</td>
                                    <td class="tb-col-ip">
                                        <span class="badge bg-success text-white">Login</span>
                                    </td>
                                    <td class="tb-col-time"><span class="sub-text">{{ $activity->created_at }}</span></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
